...
class SlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slot" do
    assert_difference("Slot.count") do
      post slots_url, params: { slot: { close_time: @slot.close_time, name: @slot.name, open_time: @slot.open_time, price: @slot.price, status: @slot.status } }
    end
  ...
  test "should update slot" do
    patch slot_url(@slot), params: { slot: { close_time: @slot.close_time, name: @slot.name, open_time: @slot.open_time, price: @slot.price, status: @slot.status } }
