...
class ParkingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parking" do
    assert_difference("Parking.count") do
      post parkings_url, params: { parking: { address: @parking.address, close_time: @parking.close_time, name: @parking.name, open_time: @parking.open_time } }
    end
  ...
  test "should update parking" do
    patch parking_url(@parking), params: { parking: { address: @parking.address, close_time: @parking.close_time, name: @parking.name, open_time: @parking.open_time } }
